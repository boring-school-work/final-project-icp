 ...
 * @return resultant matrix of mat1 x mat2
 */
matrix multiplyRows(const matrix &mat1, const matrix &mat2) {
  ...
  matrix result;
  // Resize the result matrix with correct size
  // dim = row1 x col2
...
int main() {
  try {
    ...
    matrix result = multiplyRows(mat1, mat2);
    ...
    matrix _result = multiplyRows(matrix1, matrix2);
    ...
    cout << "Execution time for large matrix: " << _duration.count() * 1000
         << " milliseconds." << endl;
